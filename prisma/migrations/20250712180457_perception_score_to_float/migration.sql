/*
  ...
  - You are about to alter the column `perceptionScore` on the `Tasting` table. The data in that column could be lost. The data in that column will be cast from `Int` to `Float`.
...
INSERT INTO "new_Tasting" ("aftertaste", "aftertasteScore", "appearance", "appearanceScore", "aroma", "aromaScore", "beerId", "carbonation", "carbonationScore", "creaminess", "creaminessScore", "createdAt", "drinkability", "drinkabilityScore", "dryFinish", "dryFinishScore", "flavor", "flavorScore", "foam", "foamScore", "id", "idealOccasion", "imageUrl", "perceptionScore", "updatedAt", "userId") SELECT "aftertaste", "aftertasteScore", "appearance", "appearanceScore", "aroma", "aromaScore", "beerId", "carbonation", "carbonationScore", "creaminess", "creaminessScore", "createdAt", "drinkability", "drinkabilityScore", "dryFinish", "dryFinishScore", "flavor", "flavorScore", "foam", "foamScore", "id", "idealOccasion", "imageUrl", "perceptionScore", "updatedAt", "userId" FROM "Tasting";
DROP TABLE "Tasting";
